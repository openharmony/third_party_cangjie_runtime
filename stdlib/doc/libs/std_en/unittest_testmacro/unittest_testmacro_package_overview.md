...
| [CustomAssertion](./unittest_testmacro_package_api/unittest_testmacro_package_macros.md#customassertion-macro) | `@CustomAssertion` designates a function as a user-defined assertion. |
