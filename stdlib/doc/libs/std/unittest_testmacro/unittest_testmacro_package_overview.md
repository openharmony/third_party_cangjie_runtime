...
| [TestTemplate](./unittest_testmacro_package_api/unittest_testmacro_package_macros.md#testtemplate-宏) | `@TestTemplate` 宏可修饰抽象类，使得它成为一个测试模板。 |
...
| [UnittestOption](./unittest_testmacro_package_api/unittest_testmacro_package_macros.md#unittestoption-宏) | 该宏可用于注册自定义配置项。只有已注册的配置项才能与单元测试框架一起使用。 |
