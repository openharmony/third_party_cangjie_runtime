...
- min!: [Option](../../core/core_package_api/core_package_enums.md#enum-optiont)\<T> - 最小值（包含）。
- max!: [Option](../../core/core_package_api/core_package_enums.md#enum-optiont)\<T> - 最大值（不包含）。
